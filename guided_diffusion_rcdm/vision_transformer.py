...
class Attention(nn.Module):   # B x num_tokens x dims
    ...
    def forward(self, x):
        ...
        # B x num_tokens x dims * 3
        # B x num_tokens x 3 x num_heads x head_dims
        # 3 x B x num_heads x num_tokens x head_dims
        
        q, k, v = qkv[0], qkv[1], qkv[2]
        # B x num_heads x num_tokens x head_dims

        attn = (q @ k.transpose(-2, -1)) * self.scale
        # B x num_heads x num_tokens x num_tokens
        ...
        # B x num_heads x num_tokens x head_dims
        # B x num_tokens x num_heads x head_dims
        # B x num_tokens x dims
